...
var style_default = genStyleHooks("Typography", (token2) => [genTypographyStyle(token2)], prepareComponentToken);
...
var Typography = React31.forwardRef((props, ref) => {
  const {
  ...
  if (true) {
    const warning3 = devUseWarning("Typography");
    warning3.deprecated(!setContentRef, "setContentRef", "ref");
  }
  const prefixCls = getPrefixCls("typography", customizePrefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls);
  const componentClassName = (0, import_classnames2.default)(prefixCls, typography === null || typography === void 0 ? void 0 : typography.className, {
  ...
  return wrapCSSVar(
    ...
    React31.createElement(Component3, Object.assign({
...
//# sourceMappingURL=chunk-MWSMFMAX.js.map
